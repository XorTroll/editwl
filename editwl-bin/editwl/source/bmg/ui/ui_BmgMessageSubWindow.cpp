...
#include <bmg/ui/ui_BmgMessageSubWindow.hpp>
#include <QDebug>
#include <QIntValidator>

namespace ui::bmg {

    BmgMessageSubWindow::BmgMessageSubWindow(BmgSubWindow *parent_win, twl::fmt::BMG *bmg_ref, const size_t idx) : SubWindow(reinterpret_cast<SubWindow*>(parent_win)), parent_win(parent_win), win_ui(new Ui::BmgMessageSubWindow), bmg_ref(bmg_ref), msg_idx(idx) {
        ...
        if(rc.IsSuccess()) {
            ...
            QMessageBox::critical(this, "BMG message editor", ("Unable to load BMG message:\n" + FormatResult(rc)));
        }
    }
