...
namespace ui::bmg {
    ...
    BmgSubWindow::BmgSubWindow(MainWindow *root, twl::fmt::BMG &&bmg, const std::string &read_path) : SubWindow(reinterpret_cast<QMainWindow*>(root)), win_ui(new Ui::BmgSubWindow), bmg(std::move(bmg)), read_path(read_path), msg_edited(false) {
    ...
    void BmgSubWindow::OnMessageListViewDoubleClick(const QModelIndex &idx) {
        ...
        auto msg_win = new BmgMessageSubWindow(this, &this->bmg, msg_idx);
